...
| **v0.1** | Tree-walking interpreter ✓, intrinsics ✓, builtin Option/Result types ✓, canonical formatter ✓, stable symbol IDs ✓, runtime contracts ✓, core stdlib (List/Deque/Array traversal, Map, Set, String, Int/Float) ✓ | **Complete** |
