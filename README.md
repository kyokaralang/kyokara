...
| **v0.3** | KyokaraIR data structures ✓, HIR→KIR lowering ✓, public WASM run/build/replay for single-file + project/package mode ✓, frozen-surface Wasm parity across strings/closures/collections/traits/output ✓, property-based testing (`kyokara test --explore`) ✓, SMT verification (restricted fragment) | In progress |
