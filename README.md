...
| **v0.1** | Tree-walking interpreter ✓, intrinsics ✓, builtin Option/Result types ✓, canonical formatter ✓, stable symbol IDs ✓, runtime contracts ✓, core stdlib (List/MutableList/Deque traversal, MutableMap/MutableSet, Map, Set, BitSet/MutableBitSet, String, Int/Float) ✓ | **Complete** |
