...
pub struct CoreTypes {
    ...
    pub mutable_deque: Option<CoreTypeInfo>,
    pub mutable_priority_queue: Option<CoreTypeInfo>,
...
impl CoreTypes {
    pub fn get(&self, core: CoreType) -> Option<CoreTypeInfo> {
        match core {
            ...
            CoreType::MutableDeque => self.mutable_deque,
            CoreType::MutablePriorityQueue => self.mutable_priority_queue,
    ...
    pub fn set(&mut self, core: CoreType, info: CoreTypeInfo) {
        match core {
            ...
            CoreType::MutableDeque => self.mutable_deque = Some(info),
            CoreType::MutablePriorityQueue => self.mutable_priority_queue = Some(info),
...
pub fn core_type_from_public_name(name: Name, interner: &Interner) -> Option<CoreType> {
    match name.resolve(interner) {
        ...
        "MutableDeque" => Some(CoreType::MutableDeque),
        "MutablePriorityQueue" => Some(CoreType::MutablePriorityQueue),
