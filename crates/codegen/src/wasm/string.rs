...
pub fn emit_flatten_into_function(flatten_into_fn_index: u32) -> Function {
...
pub fn emit_flatten_function(alloc_fn_index: u32, flatten_into_fn_index: u32) -> Function {
