...
| Local mutable bindings and reassignment | [`docs/rfcs/0012-local-var-bindings.md`](rfcs/0012-local-var-bindings.md) | Narrow local-only `var` + bare-name assignment surface for loop-carried state. |
