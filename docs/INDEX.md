...
| Loop control surface | [`docs/rfcs/0006-loop-control-surface.md`](rfcs/0006-loop-control-surface.md) | Statement-only `while` / `for` / `break` / `continue`; RFC 0012 completes loop-carried local state. |
...
| Local mutable bindings and reassignment | [`docs/rfcs/0012-local-var-bindings.md`](rfcs/0012-local-var-bindings.md) | Narrow local-only `var` + bare-name assignment surface for loop-carried state; top-level `var` remains invalid. |
