...
| Collection naming/placement/mutability | [`docs/rfcs/0009-collection-surface-normalization.md`](rfcs/0009-collection-surface-normalization.md), [`docs/rfcs/0010-bitset-surface.md`](rfcs/0010-bitset-surface.md) | RFC 0009 is the canonical collection freeze doc. RFC 0005 and RFC 0008 are superseded lineage for the early mutable-collection naming and follow-up map/set phases. |
...
| Package manifests and external imports | [`docs/rfcs/0015-package-manifests-and-external-library-distribution.md`](rfcs/0015-package-manifests-and-external-library-distribution.md) | Implemented package/lockfile/import-boundary design for reusable libraries and external dependencies. |
